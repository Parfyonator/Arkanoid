...
.no_sse:
	...
	; detect Streaming Simd Extensions 2 ( SSE2 )
	test    edx,0x4000000
	jz      .no_sse2
...
.no_3dnow:
	...
	; detect AMD Extensions to the 3DNow!
	push    eax
	mov     eax,0x80000001
	cpuid
	pop     eax
...
.no_3dnowext:
	...
	; detect AMD Extensions to the MMX
	push    eax
	mov     eax,0x80000001
	cpuid
	pop     eax
...
; 20.11.2001; Daniel Kolakowski (danhawk@scene.pl):
; - small adaptation for NASM assembler,
; - added saving of ebx and edx registers for the case caller uses it
...
; getting maximum read bandwidth, especially in DDR memory systems.
	...
	; export
global  x86_amd_memcpy
global _x86_amd_memcpy
global  x86_amd_memcpy_
